...
local function registerChatHandlers()
	...
	AddEventHandler('chat:init', function()
		TriggerClientEvent('chatMessage', -1, '', {255, 255, 255}, '^2* ' .. Server.getName(source) .. '^r^2 joined.')
	...
	AddEventHandler('poodlechat:whisperMessage', function(id, message)
		...
		TriggerClientEvent('poodlechat:whisperEcho', source, target, recvLicense, Server.getNameWithId(target), text)
